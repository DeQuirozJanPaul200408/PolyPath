...
public class chinalanguage4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mysound = MediaPlayer.create(this, R.raw.duibuqi);
        ...
        btnSubmit.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(this, chinalanguage5.class);
            intent.putExtra("correctAnswersCount", correctAnswersCount);
            startActivity(intent);
        });

        Button btnBack = findViewById(R.id.btnBack);
        btnBack.setOnClickListener(v -> finish()); // back to chinalanguage3.java
    }
}
