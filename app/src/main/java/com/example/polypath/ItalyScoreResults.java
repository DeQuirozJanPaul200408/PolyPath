...
public class ItalyScoreResults extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_italy_score_results);
        ...
        returnButton.setOnClickListener(v -> {
            Intent intent = new Intent(ItalyScoreResults.this, MainActivity.class);
