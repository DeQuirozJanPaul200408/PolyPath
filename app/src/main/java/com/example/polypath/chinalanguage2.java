...
public class chinalanguage2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mysound = MediaPlayer.create(this, R.raw.zaoan);
        ...
        btnSubmit.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(this, chinalanguage3.class);
            intent.putExtra("correctAnswersCount", correctAnswersCount);
            startActivity(intent);
        });

        Button btnBack = findViewById(R.id.btnBack);
        btnBack.setOnClickListener(v -> finish()); // back to chinalanguage.java
    }
}
