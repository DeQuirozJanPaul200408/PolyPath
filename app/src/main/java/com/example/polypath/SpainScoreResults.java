...
public class SpainScoreResults extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_spain_score_results);
        ...
        Log.d("SpainScoreResults", "User Answers: " + java.util.Arrays.toString(userAnswers));
        ...
        returnButton.setOnClickListener(v -> {
            Intent intent = new Intent(SpainScoreResults.this, MainActivity.class);
